...
$(document).ready(function(){
    ...
    convertButton = function(button, classes) {
        var primaryExists = jQuery('.btn-primary', button.parent());
        console.log(button);
        if(button.hasClass('context') && !primaryExists){
            button.removeClass();
    ...
    var formButtonsSelector = 'div.formControls input[type="submit"], div.formControls input[type="reset"]'
    $(formButtonsSelector).each(function(){
        var input = $(this);
